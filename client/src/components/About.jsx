    ...
    <div className=" min-h-screen flex flex-col lg:flex-row justify-between items-center lg:px-32 px-5 pt-24 lg:pt-16 gap-5">
      ...
      <div className=" w-full lg:w-3/4">
        <img
          ...
          src="https://img.freepik.com/free-photo/happy-doctor-holding-clipboard-with-patients_1098-2176.jpg?w=996&t=st=1702667664~exp=1702668264~hmac=6c1704a8215a3f2a1380244f71e3f7aed2de5e6c1e21324eab4e4a7187d1ea02"
          alt="img"
        />
      </div>
    </div>
